        ...
        return inquirer.prompt(
            ...
            switch (shape) {
                case 'Triangle':
                    ...
                    Fs.writeFile('triangle.svg', newTriangle.svgTemp(), (err) => err ? console.error(err) : console.log('sucess!'))
                    break;


                case 'Circle':
                    const newCircle = new Circle(characters, textColor, shapeColor);
                    Fs.writeFile('circle.svg', newCircle.svgTemp(), (err) => err ? console.error(err) : console.log('sucess!'));
                    break;
                ...
                case 'Square':
                    ...
                    Fs.writeFile('square.svg', newSquare.svgTemp(), (err) => err ? console.error(err) : console.log('sucess!'));
                    break;
